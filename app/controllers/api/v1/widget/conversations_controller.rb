class Api::V1::Widget::ConversationsController < Api::V1::Widget::BaseController
  ...
  def permitted_params
    params.permit(:id, :typing_status, :website_token, :email, contact: [:name, :email, :phone_number, { custom_attributes: {}, additional_attributes: {} }],
                                                               message: [:content, :referer_url, :timestamp, :echo_id],
                                                               custom_attributes: {})
  end

  def contact_additional_attributes
    permitted_params.dig(:contact, :additional_attributes)&.to_h
  end
end
